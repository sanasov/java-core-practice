...
public class CardGame {
    ...
    public CardGame(String row1, String row2) {
    ...
    public static String readFileAsString() throws IOException {
        return new String(Files.readAllBytes(Paths.get("C:\\projects\\java-core-practice\\algorithm\\src\\main\\resources\\input.txt")));
    }

    public static void main(String[] args) throws IOException {
        String row1 = readFileAsString().split("\n")[0];
        String row2 = readFileAsString().split("\n")[1];
        System.out.println(new CardGame(row1, row2).findWinner());
    }
}
